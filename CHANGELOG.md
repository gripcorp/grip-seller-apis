### ⚠️ Breaking Change 사전 안내 — 도메인별 순차 적용 (2026.08.21 ~ 09.03)
...
| --- | --- | --- | --- |
| 1:1 문의 | [문의](docs/qna/README.md) | 2026.08.21 | 2026.08.26 |
| 멤버(계정) | [멤버](docs/group/README.md) | 2026.08.21 | 2026.08.26 |
| 리뷰 | [리뷰](docs/review/README.md) | 2026.08.21 | 2026.08.26 |
| 주문 | [주문/반품/교환](docs/order/README.md) | 2026.08.25 | 2026.08.28 |
| 상품 | [상품](docs/product/README.md) | 2026.08.26 | 2026.09.01 |
| 배송 | [배송](docs/delivery/README.md) | 2026.08.31 | 2026.09.03 |

- **2026.08.25 기준 진행 현황**: 1:1 문의 / 멤버(계정) / 리뷰 도메인은 현재 요청의 약 75%에 변경된 방식이 적용 중이며, **2026.08.26에 100% 전환이 완료됩니다.** 이후 해당 도메인 API의 오류 응답은 항상 변경된 방식(`4xx` 체계)으로 응답됩니다.
